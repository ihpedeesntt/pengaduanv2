    ...
    <header class="header" id="home__header">
        <div class="header__container" style="width:100%;">
            <nav class="navbar navbar-expand-lg navbar-dark header__nav" id="navbar">
                <a href="#home" class="scrollto"><img src="/creative/img/peluit.png" alt="" title=""
                        width="100px"></a>
    ...
    <section class="home" id="beranda">
        <div class="container text-center text-light" style="width:100%;">
            <div class="home__desc" style="width:100%;">
                <br>
                <p>Portal Layanan Pengaduan TEST SERVER</p>
            ...
            <div class="portfolio__wrapper">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p>Whistleblowing System BPS adalah aplikasi yang disediakan oleh Badan Pusat Statistik bagi
                            Anda yang memiliki informasi dan ingin melaporkan suatu perbuatan berindikasi pelanggaran
                            yang terjadi di lingkungan Badan Pusat Statistik
                        ...
                        <p>BPS menghargai informasi yang Anda laporkan dan fokus kami adalah kepada materi informasi
                            yang anda sampaikan. Anda tidak perlu khawatir terungkapnya identitas diri anda karena kami
        ...
        <div class="center">
            ...
            <div class="container"style="width:100%;">
                <form action="/tiket" method="POST" autocomplete="off">
                    {{ csrf_field() }}
                    <input type="text" class="col-md-3" name="tiket" id="tiket"
                        placeholder="Masukan Nomor Tiket"style="text-align:center;">
                    <div class="controls">
    ...
    <footer class="footer">
        <div class="container"style="width:100%;">
            ...
            <div class="footer__sm-box">
                <a href="https://www.facebook.com/bps5300" class="footer__sm-link" target="_blank"><i
                        class="fa fa-facebook"></i></a>
                <a href="https://www.instagram.com/bps.ntt/" class="footer__sm-link" target="_blank"><i
                        class="fa fa-instagram"></i></a>
                <a href="https://api.whatsapp.com/send?phone=6287820178535 " class="footer__sm-link"
                    target="_blank"><i class="fa fa-whatsapp"></i></a>
                <a href="https://www.youtube.com/channel/UCToBos26nIog1oKbN4OPP0Q" class="footer__sm-link"
